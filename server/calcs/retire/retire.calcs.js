...
//this function calculates inflation adjusted longTerm savings with 
  ...
  var monthlyReturns = [0.05344,-0.03153,-0.00420,0.02424,0.02294,-0.01564,0.03696,-0.01519,0.01888,0.02081,0.00618,0.00691,0.04221,-0.03623,0.02329,0.02766,0.04363,0.02932,-0.03180,0.04828
                        ...
                        ,-0.02870,0.02125,0.05328,-0.08931,0.06877,-0.06048,0.01401,0.04901,-0.01425,0.05145,0.06905,0.00236,0.04408,0.06303,0.04163,-0.03534,-0.01207,-0.00486,0.01206,0.05264,-0.00460]; 
  //this is the monthly returns //need monthly data for 30 years from yahoo finance,
    //need 360 monthly returns;
    var newMonthReturns = [];
    var yearlyReturns = [];
    ...
    var fini = 12;
    var calcYearRet = function(start, finish){
      var result;
      var subArr = newMonthReturns.slice(start, finish);
    ...
    for(var i=0; i<1000; i++){  // 1000 iterations X 30 years
      yearlyReturns.push([]);
      for(var j=0; j<30; j++){
        yearlyReturns[i].push(calcYearRet(fini-12, fini));
        fini+=12;
      }
    ...
    for(var j=0; j<30; j++){
      for(var i=0; i<1000; i++){
        sum+=yearlyReturns[i][j];
      }
      thirtyYearlyReturns.push(sum);
    }
